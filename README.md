...
### Cheetah is compatible with both Linux (Ubuntu) and macOS, enabling effortless deployment of TigerGraph Database DDL scripts either locally or in the cloud with minimal effort
